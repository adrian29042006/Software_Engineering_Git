...
class TempController:
    ...
    def update_temperature(self):
        if self.power_manager.level > 0:
            self.temp_sensor.set_temp(self.temp_sensor.get_temp() + self.power_manager.level * 0.5)
        else:
            if self.temp_sensor.get_temp() > 25:
                self.temp_sensor.set_temp(self.temp_sensor.get_temp() - 0.5)
